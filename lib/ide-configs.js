...
function claudeConfig() {
  return [
    {
      path: path.join(".claude", "skillforge.md"),
      content: [
        ...
        "",
        "Try commands like /brainstorm, /prd, /specify, /clarify, /plan, /tasks, /analyze, /checklist, /doc, /enhance, /create, /implement, /debug, /test, /deploy, and /ui-ux-pro-max.",
        ""
      ].join("\n")
    }
  ];
...
function cursorConfig() {
  return [
    {
      path: path.join(".cursor", "rules", "skillforge.md"),
      content: [
        "# Skillforge Rules for Cursor",
        "",
...
function windsurfConfig() {
  return [
    {
      path: path.join(".windsurf", "skillforge.md"),
      content: [
        "# Skillforge Configuration for Windsurf",
        "",
  ...
  return [
    {
      ...
      content: [
        "# Skillforge Configuration for Codex",
        "",
